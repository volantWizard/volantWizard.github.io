...
(function(global, factory) {
    ...
    $.fn.fullpage = function(options) {
        ...
        options = $.extend({
            //navigation
            menu: false,                //配置菜单
            anchors:[], //配置锚链接，不应该和autoScrolling，scrollBar一起使用
            lockAnchors: false,         //锁定配置的锚链接是否显示，默认false
            navigation: false,          //navigation是否显示导航，默认为false
            navigationPosition: 'left', //navigationPosition导航小圆点的位置
            navigationTooltips: [],     
            showActiveTooltip: false,   //showActiveTooltip是否显示当前页面的tooltip信息，默认为false 
            slidesNavigation: false,    //slidesNavigation 是否显示横向幻灯片的导航，默认为false
            slidesNavPosition: 'bottom',//slidesNavPosition横向导航的位置，默认为bottom，可以设置为top或bottom
            scrollBar: false,           //滚动的时候是否包含滚动条,默认false,和锚点不应该一起使用，一般不设置或者保持默认
            hybrid: false,

            //scrolling
            css3: true,                 //配置动画由css3还是jquery来执行，默认true
            scrollingSpeed: 2000,       //配置页面滚动速度,默认700
            autoScrolling: true,        //配置是否按照插件的方式来进行滚动，默认true,和锚点不应该一起使用，一般不设置或者保持默认
            //false会按照滚动条的方式进行滚动
            fitToSection: true,
            fitToSectionDelay: 1000,
            easing: 'easeInOutCubic',  //滚动动画方式
            easingcss3: 'ease',
            loopBottom: false,         //相反从底部循环滚动，默认false
            loopTop: false,            //配置滚动到顶部之后是否从底部循环滚动，默认false
            ...
            //Accessibility
            keyboardScrolling: true,     //配置是否支持键盘方向键控制页面切换，默认true
            animateAnchor: true,         //是否循环滚动，与 loopTop 及 loopBottom 不兼容
            recordHistory: true,
            ...
            sectionsColor : [],           //给每个块设置颜色['#f2f2f2', '#4BBFC3', '#7BAABE']
            paddingTop: 0,
            paddingBottom: 0,
            fixedElements: null,
            ...
            afterLoad: function (anchorLink,index){
                ...
                //console.log("afterLode:anchorLink"+anchorLink+";index:"+index);
            ...
            afterRender: null,  // 页面结构生成后的回调函数，或者说页面初始化完成后的回调函数
