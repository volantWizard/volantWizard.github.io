define(function (require,exports,module){
    ...
    inner1 = 
    	'<div style="position: absolute; transform: translate3d(-50%, -50%, 0px) translate3d(0px, 0px, 0px) rotateX(0deg) rotateY(0deg) rotateZ(0deg) scale3d(0.7, 0.7, 0.7); transform-style: preserve-3d; transform-origin: 50% 50% 0px; opacity: 1; display: block;">'
			...
			+'<div style="position: absolute; transform: translate3d(-50%, -50%, 0px) translate3d(196.32px, 162.92px, 296.32px) rotateX(0deg) rotateY(-135deg) rotateZ(65deg) scale3d(0, 0, 0); transform-style: preserve-3d; width: 50px; height: 33px; transform-origin: 50% 50% 0px; opacity: 1; display: block; background-image: url(images/music.png);"></div>'
			+'<div style="position: absolute; transform: translate3d(-50%, -50%, 0px) translate3d(196.32px, 162.92px, 296.32px) rotateX(0deg) rotateY(-135deg) rotateZ(1deg) scale3d(0, 0, 0); transform-style: preserve-3d; width: 50px; height: 33px; transform-origin: 50% 50% 0px; opacity: 1; display: block; background-image: url(images/music.png);"></div>'
			+'<div style="position: absolute; transform: translate3d(-50%, -50%, 0px) translate3d(196.32px, 162.92px, 296.32px) rotateX(0deg) rotateY(-135deg) rotateZ(118deg) scale3d(0, 0, 0); transform-style: preserve-3d; width: 50px; height: 33px; transform-origin: 50% 50% 0px; opacity: 1; display: block; background-image: url(images/music.png);"></div>'
			+'<div style="position: absolute; transform: translate3d(-50%, -50%, 0px) translate3d(196.32px, 162.92px, 296.32px) rotateX(0deg) rotateY(-135deg) rotateZ(31deg) scale3d(0, 0, 0); transform-style: preserve-3d; width: 50px; height: 33px; transform-origin: 50% 50% 0px; opacity: 1; display: block; background-image: url(images/music.png);"></div>'
			+'<div style="position: absolute; transform: translate3d(-50%, -50%, 0px) translate3d(196.32px, 162.92px, 296.32px) rotateX(0deg) rotateY(-135deg) rotateZ(44deg) scale3d(0, 0, 0); transform-style: preserve-3d; width: 50px; height: 33px; transform-origin: 50% 50% 0px; opacity: 1; display: block; background-image: url(images/music.png);"></div>'
			...
			+'<div style="position: absolute; transform: translate3d(-50%, -50%, 0px) translate3d(177.1px, 209.53px, 379.8px) rotateX(0deg) rotateY(-155deg) rotateZ(0deg) scale3d(0, 0, 0); transform-style: preserve-3d; width: 300px; height: 178px; transform-origin: 50% 50% 0px; opacity: 1; display: block; background-image: url(images/text2.png);"></div>'
			...
			+'<div style="position: absolute; transform: translate3d(-50%, -50%, 0px) translate3d(-419.06px, 16.52px, 0px) rotateX(0deg) rotateY(-270deg) rotateZ(0deg) scale3d(1, 1, 1); transform-style: preserve-3d; width: 100px; height: 77px; transform-origin: 50% 50% 0px; opacity: 1; display: block; background-image: url(images/video.png);"></div>'
			+'<div style="position: absolute; transform: translate3d(-50%, -50%, 0px) translate3d(-177.1px, 0px, 379.8px) rotateX(0deg) rotateY(-205deg) rotateZ(0deg) scale3d(0, 0, 0); transform-style: preserve-3d; width: 300px; height: 187px; transform-origin: 50% 50% 0px; opacity: 1; display: block; background-image: url(images/text3.png);"></div>'
    ...
    inner2 = 
    	'<div style="position: absolute; transform: translate3d(-50%, -50%, 0px) translate3d(0px, 0px, 0px) rotateX(0deg) rotateY(0deg) rotateZ(0deg) scale3d(0.75, 0.75, 0.75); transform-style: preserve-3d; transform-origin: 50% 50% 0px; opacity: 1; display: block;">'
			+'<div style="position: absolute; transform: translate3d(-50%, -50%, 0px) translate3d(-321.02px, -402.83px, 269.37px) rotateX(0deg) rotateY(-230deg) rotateZ(0deg) scale3d(1, 1, 1); transform-style: preserve-3d; width: 192px; height: 170px; transform-origin: 50% 50% 0px; opacity: 1; display: block; background-image: url(images/30.png);"></div>'
			...
			+'<div style="position: absolute; transform: translate3d(-50%, -50%, 0px) translate3d(143.33px, 0px, -393.79px) rotateX(0deg) rotateY(-20deg) rotateZ(0deg) scale3d(1, 1, 1); transform-style: preserve-3d; width: 338px; height: 271px; transform-origin: 50% 50% 0px; opacity: 0; display: block; background-image: url(images/51.png);"></div>'
			...
			+'<div style="position: absolute; transform: translate3d(-50%, -50%, 0px) translate3d(343.27px, -359.21px, 240.36px) rotateX(0deg) rotateY(-125deg) rotateZ(0deg) scale3d(1, 1, 1); transform-style: preserve-3d; width: 300px; height: 295px; transform-origin: 50% 50% 0px; opacity: 1; display: block; background-image: url(images/48.png);"></div>'
