define(function (require,exports,module){
	...
	function css(element, attr , val){
		...
		if(attr=='scale'|| attr=='rotate'|| attr=='rotateX'|| attr=='rotateY'|| attr=='rotateZ'|| attr=='scaleX'|| attr=='scaleY'||attr=='scaleZ'|| attr=='translateY'|| attr=='translateX'|| attr=='translateZ' || attr=='skewX' || attr=='skewY'||attr=='skewZ'||attr=='translate3d'||attr=='scale3d'||attr =='rotate3d'){
			return setTransform(element, attr , val);
		}
	...
	function setTransform(element,attr,val){
		...
		if (attr.constructor===Object) {
			...
			for (var s in attr) {
				...
				switch(s){
					...
					case 'translateY':
					case 'translateZ':	
						/\%/.test(attr[s])? (str += s+"("+element["transform"][s]+")"):
		...
		element.style.WebkitTransform = str ;
		element.style.MozTransform = str ; 
		element.style.msTransform  = str ; 
